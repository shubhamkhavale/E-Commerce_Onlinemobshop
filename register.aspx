<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="VariableMobileShop.register" %>
      ...
      <form>
        <label for="username">Username</label>
          ...
          <asp:TextBox ID="cpass" CssClass="input" runat="server" TextMode="Password"></asp:TextBox>
           <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Please Enter Conform Password" ControlToValidate="cpass" SetFocusOnError="True" Display="Dynamic" ForeColor="Red" Font-Size="20px"></asp:RequiredFieldValidator>
